...
for i in range(0,total_samples-1):
    c = [data['expected_afs_M{}'.format(M)][i]/data['panmictic_afs'][i] for M in list_M]
    list_c.append(c)
...
if not os.path.exists('graphs'):
    os.mkdir('graphs')
path = os.path.join('graphs', 'Converge1_10i_sampling_type={}_k={}_omega=1.25_theta=0.1'.format(sampling_scheme,total_samples))
